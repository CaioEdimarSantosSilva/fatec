-- banco.sql - Estrutura do banco de dados EstanteFilmes
...
('Usuário Teste', 'usuario@estante.com', 'user123', 'usuario');
...
(2, 1, 5, 'Filme incrível! A trama é muito bem construída.'),
(2, 2, 5, 'Obra-prima do cinema coreano. Imperdível!'),
(2, 3, 5, 'Emocionante do início ao fim. Nolan é genial!');