...
urlpatterns = [
    ...
    path('produto/<int:id_prod>', views.detalheProduto, name="detalheproduto"),
    ...
    path('dashboard/compras/del/<int:id_compra>', views.delCompra, name="delcompra"),
    path('dashboard/avaliacoes', views.listarAvaliacoesAdmin, name="avaliacoesadmin"),
    path('dashboard/avaliacoes/del/<str:id_avaliacao>', views.delAvaliacaoAdmin, name="delavaliacaoadmin"),
